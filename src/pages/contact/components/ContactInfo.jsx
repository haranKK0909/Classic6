  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-background rounded-2xl shadow-soft p-8">
        <h3 className="font-script text-xl font-medium text-foreground mb-6">
          Get In Touch
        </h3>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  <h4 className="font-accent text-sl font-medium text-foreground">
                    {contact?.label}
                  </h4>
                  {contact?.action && (
                ...
                <p className="font-accent text-foreground font-medium mb-1">
                  {contact?.value}
                </p>
                <p className="font-accent text-xsl text-muted-foreground">
                  {contact?.description}
                </p>
              </div>
            </div>
          ...
          {socialLinks?.map((social, index) => (
            ...
            >
              ...
              <div className="flex-1">
                <h4 className="font-accent text-sl font-medium text-foreground group-hover:text-accent transition-organic">
                  {social?.name}
                </h4>
                <p className="font-accent text-xsl text-muted-foreground">
                  {social?.description}
      ...
      {/* <div className="bg-background rounded-2xl shadow-soft p-8">
        ...
        <div className="space-y-4">
          <Button
            ...
            className="justify-start font-accent"
          >
            Schedule a Call
          </Button>
      ...
      <div className="bg-accent/5 border border-accent/20 rounded-2xl p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h4 className="font-accent text-ssl font-medium text-foreground mb-1">
              Last-Minute Bookings
            </h4>
            <p className="font-accent text-xs text-muted-foreground mb-3">
